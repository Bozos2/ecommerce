const DUMMY_DATA = [
  /*  {
    ...
    title: "Home Transformation Stories: How Customers Changed Their Space",
    background:
      "https://images.pexels.com/photos/3823488/pexels-photo-3823488.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
      "Greetings to all interior design enthusiasts! Your home's story is your story. In this article, we present inspiring tales from our loyal customers who turned their homes into havens of style and comfort with the help of our furniture. Their interior design adventures showcase how the right choice of furniture can transform a room and create an ambiance that reflects their personality. Dive into these stories, learn about the challenges they conquered, and be inspired to turn your own home into a design masterpiece.",
    category: "Stories",
  }, */
  {
    id: "2",
    ...
    background:
      "https://images.pexels.com/photos/5691630/pexels-photo-5691630.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
  ...
  },
  {
    ...
    background:
      "https://images.pexels.com/photos/7005299/pexels-photo-7005299.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
  ...
  },
  {
    ...
    background:
      "https://images.pexels.com/photos/3965563/pexels-photo-3965563.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
  ...
  },
  {
    ...
    background:
      "https://images.pexels.com/photos/1708601/pexels-photo-1708601.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
  ...
  },
  {
    ...
    background:
      "https://images.pexels.com/photos/3890163/pexels-photo-3890163.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    subtitle:
  ...
  return (
    <div className="flex justify-center">
      <div className="flex  flex-col justify-center  items-center max-w-[1200px]">
        <div className="flex flex-col items-center justify-center gap-4  w-full  h-44 m-8 rounded-lg bg-zinc-300">
